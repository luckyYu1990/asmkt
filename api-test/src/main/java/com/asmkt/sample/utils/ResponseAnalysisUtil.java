...
public class ResponseAnalysisUtil {
    ...
    public static void analysisResponseWithAvg(TestResult result, Condition condition) {
        List<TestResponse> results = result.getResults();
        int success = 0;
    ...
    private static double getValueRetain2DecimalPlaces(double numerator , double denominator) {
